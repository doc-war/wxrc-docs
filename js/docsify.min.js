...
function() {
    ...
    var M = i(function(m, e) { !
        ...
        ie = function(i, e) {
            ...
            if (t = i, a.include) {
                var o;
                if (X(e) || (e = K(this.contentBase, Q(this.router.getCurrentPath()), e)), a.type && (o = re[a.type]))(n = o.call(this, e, t)).type = a.type;
                else {
                    var s = "code";
        ...
        var Ne, ze, Me, qe, He = je.prototype;He._init = function() {
            ...
            e.onchange(function(e) {
                Re(r),
                r._updateRender(),
                Te.path !== r.route.path ? (r.$fetch(), Te = r.route) : r.$resetEvents()
            }),
            Se(a),
            Pe(a),
            function(t) {
        ...
        window.DocsifyCompiler = ie, window.marked = M, window.Prism = a,
        function(e) {
